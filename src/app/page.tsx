...
import { SignInButtons, ShowFormModal, AccountDropDown, JobApplications } from 'src/components'
...
export default async function Home() {
	...
	return (
		<>
			<header className="flex grow items-center justify-between p-4">
				<h1 className="text-2xl font-bold">Job Application Tracker</h1>
				<AccountDropDown profilePicture={session.user.image ?? ''} userEmail={session.user.email ?? ''} />
			</header>
